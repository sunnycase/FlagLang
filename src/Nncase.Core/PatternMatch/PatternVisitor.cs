...
public abstract class PatternVisitor<TExprPatternResult, TTypeResult> : PatternFunctor<TExprPatternResult, TTypeResult>
{
    ...
    public virtual TExprPatternResult VisitLeaf(IPattern pattern)
    {
        return pattern switch
        {
            ...
            IRBlockPattern block => VisitLeaf(block),
    ...
    /// <summary>
    /// Visit leaf IR block pattern.
    /// </summary>
    /// <param name="pattern">IR block pattern.</param>
    /// <returns>Result.</returns>
    public virtual TExprPatternResult VisitLeaf(IRBlockPattern pattern) => DefaultVisitLeaf(pattern);

...
public static class T
{
    ...
    public static ISequentialBuilder<Sequential> Sequential(ReadOnlySpan<IVar> parameters = default)
    {
        return new SequentialBuilder<Sequential>(body => body, parameters);
    }

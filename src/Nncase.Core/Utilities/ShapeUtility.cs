...
public static class ShapeUtility
{
    ...
    {
        var thenFunc = new IRBlock(thenExpr());
        var elseFunc = new IRBlock(elseExpr());
    ...
    public static Expr If(Expr condition, Func<Var, Expr> thenExpr, Func<Var, Expr> elseExpr, Expr arg)
    {
        ...
        var var2 = var1.With();
        var thenFunc = new IRBlock(thenExpr(var1));
        var elseFunc = new IRBlock(elseExpr(var2));
    ...
    public static Expr If(Expr condition, Func<Var, Var, Expr> thenExpr, Func<Var, Var, Expr> elseExpr, Expr arg1, Expr arg2)
    {
        ...
        var thenFunc = new IRBlock(thenExpr(var11, var12));
        var elseFunc = new IRBlock(elseExpr(var21, var22));

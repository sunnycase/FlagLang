...
{
    /// <inheritdoc />
    protected internal override TExprResult VisitIRModule(IRModule expr, TContext context)
    {
        ...
        return VisitLeafIRModule(expr, context);
    }

    /// <inheritdoc />
    protected internal override TExprResult VisitIRBlock(IRBlock expr, TContext context)
    {
        VisitOperands(expr, context);
        if (CanVisitAttributes(expr))
        {
        ...
        return VisitLeafIRBlock(expr, context);
    }
    ...
    /// <inheritdoc />
    protected internal override TExprResult VisitProgramIdDim(Distributed.ProgramIdDim expr, TContext context)
    {
        VisitOperands(expr, context);
        if (CanVisitAttributes(expr))
        {
        ...
        return VisitLeafProgramIdDim(expr, context);
    }
    ...
    /// </summary>
    protected virtual TExprResult VisitLeafIRModule(IRModule expr, TContext context) => DefaultVisitLeaf(expr, context);

    /// <summary>
    /// Visit leaf <see cref="IRBlock"/>.
    /// </summary>
    protected virtual TExprResult VisitLeafIRBlock(IRBlock expr, TContext context) => DefaultVisitLeaf(expr, context);
    ...
    /// <summary>
    /// Visit leaf <see cref="Distributed.ProgramIdDim"/>.
    /// </summary>
    protected virtual TExprResult VisitLeafProgramIdDim(Distributed.ProgramIdDim expr, TContext context) => VisitLeafDimension(expr, context);
...
{
    /// <summary>
    /// Visit <see cref="IRModule"/>.
    /// </summary>
    internal protected virtual TExprResult VisitIRModule(IRModule expr) => base.VisitIRModule(expr, default);
    
    /// <inheritdoc/>
    internal protected sealed override TExprResult VisitIRModule(IRModule expr, Unit context) => VisitIRModule(expr);
    /// <summary>
    /// Visit <see cref="IRBlock"/>.
    /// </summary>
    internal protected virtual TExprResult VisitIRBlock(IRBlock expr) => base.VisitIRBlock(expr, default);
    
    /// <inheritdoc/>
    internal protected sealed override TExprResult VisitIRBlock(IRBlock expr, Unit context) => VisitIRBlock(expr);
    /// <summary>
    /// Visit <see cref="Call"/>.
    /// </summary>
    ...
    /// <summary>
    /// Visit <see cref="Distributed.ProgramIdDim"/>.
    /// </summary>
    internal protected virtual TExprResult VisitProgramIdDim(Distributed.ProgramIdDim expr) => base.VisitProgramIdDim(expr, default);
    
    /// <inheritdoc/>
    internal protected sealed override TExprResult VisitProgramIdDim(Distributed.ProgramIdDim expr, Unit context) => VisitProgramIdDim(expr);
    /// <summary>
    ...
    /// Visit leaf <see cref="IRModule"/>.
    /// </summary>
    protected virtual TExprResult VisitLeafIRModule(IRModule expr) => base.VisitLeafIRModule(expr, default);
    
    /// <inheritdoc/>
    protected sealed override TExprResult VisitLeafIRModule(IRModule expr, Unit context) => VisitLeafIRModule(expr);

    /// <summary>
    /// Visit leaf <see cref="IRBlock"/>.
    /// </summary>
    protected virtual TExprResult VisitLeafIRBlock(IRBlock expr) => base.VisitLeafIRBlock(expr, default);
    
    /// <inheritdoc/>
    protected sealed override TExprResult VisitLeafIRBlock(IRBlock expr, Unit context) => VisitLeafIRBlock(expr);
    ...
    /// Visit leaf <see cref="Distributed.ProgramIdDim"/>.
    /// </summary>
    protected virtual TExprResult VisitLeafProgramIdDim(Distributed.ProgramIdDim expr) => base.VisitLeafProgramIdDim(expr, default);
    
    /// <inheritdoc/>
    protected sealed override TExprResult VisitLeafProgramIdDim(Distributed.ProgramIdDim expr, Unit context) => VisitLeafProgramIdDim(expr);

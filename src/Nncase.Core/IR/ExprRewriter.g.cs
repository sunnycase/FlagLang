...
{
    /// <inheritdoc/>
    protected sealed override BaseExpr VisitLeafIRModule(IRModule expr, TContext context)
    {
        return RewriteLeafIRModule(expr, context);
    }

    /// <inheritdoc/>
    protected sealed override BaseExpr VisitLeafIRBlock(IRBlock expr, TContext context)
    {
        return RewriteLeafIRBlock(expr, context);
    }
    ...
    /// <inheritdoc/>
    protected sealed override BaseExpr VisitLeafProgramIdDim(Distributed.ProgramIdDim expr, TContext context)
    {
        return RewriteLeafProgramIdDim(expr, context);
    }
    ...
    /// </summary>
    protected virtual BaseExpr RewriteLeafIRModule(IRModule expr, TContext context) => DefaultRewriteLeaf(expr, context);

    /// <summary>
    /// Rewrite leaf <see cref="IRBlock"/>.
    /// </summary>
    protected virtual BaseExpr RewriteLeafIRBlock(IRBlock expr, TContext context) => DefaultRewriteLeaf(expr, context);
    ...
    /// <summary>
    /// Rewrite leaf <see cref="Distributed.ProgramIdDim"/>.
    /// </summary>
    protected virtual BaseExpr RewriteLeafProgramIdDim(Distributed.ProgramIdDim expr, TContext context) => RewriteLeafDimension(expr, context);
...
public partial class ExprRewriter
{
    ...
    /// Rewrite leaf <see cref="IRModule"/>.
    /// </summary>
    protected virtual BaseExpr RewriteLeafIRModule(IRModule expr) => DefaultRewriteLeaf(expr);

    /// <inheritdoc />
    protected sealed override BaseExpr RewriteLeafIRModule(IRModule expr, Unit context) => RewriteLeafIRModule(expr);

    /// <summary>
    /// Rewrite leaf <see cref="IRBlock"/>.
    /// </summary>
    protected virtual BaseExpr RewriteLeafIRBlock(IRBlock expr) => DefaultRewriteLeaf(expr);

    /// <inheritdoc />
    protected sealed override BaseExpr RewriteLeafIRBlock(IRBlock expr, Unit context) => RewriteLeafIRBlock(expr);
    ...
    /// Rewrite leaf <see cref="Distributed.ProgramIdDim"/>.
    /// </summary>
    protected virtual BaseExpr RewriteLeafProgramIdDim(Distributed.ProgramIdDim expr) => RewriteLeafDimension(expr);

    /// <inheritdoc />
    protected sealed override BaseExpr RewriteLeafProgramIdDim(Distributed.ProgramIdDim expr, Unit context) => RewriteLeafProgramIdDim(expr);

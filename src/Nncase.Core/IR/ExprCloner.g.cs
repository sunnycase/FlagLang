...
{
    /// <inheritdoc />
    protected override BaseExpr VisitLeafIRModule(IRModule expr, TContext context)
    {
        bool IsOperandsMutated()
        {
            if (IsMutatedArray(expr.Functions, context))
            {
                return true;
            }
        ...
        {
            return expr.With(
                functions: CloneArray(expr.Functions, context)
            );
        }
    ...
    /// <inheritdoc />
    protected override BaseExpr VisitLeafIRBlock(IRBlock expr, TContext context)
    {
        bool IsOperandsMutated()
        {
    ...
    /// <inheritdoc />
    protected override BaseExpr VisitLeafProgramIdDim(Distributed.ProgramIdDim expr, TContext context)
    {
        bool IsOperandsMutated()
        {
            return false;

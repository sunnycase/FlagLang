...
public partial class ExprFunctor<TExprResult, TTypeResult, TContext>
{
    ...
    /// </summary>
    internal protected virtual TExprResult VisitIRModule(IRModule expr, TContext context) => DefaultVisit(expr, context);

    /// <summary>
    /// Visit <see cref="IRBlock"/>.
    /// </summary>
    internal protected virtual TExprResult VisitIRBlock(IRBlock expr, TContext context) => DefaultVisit(expr, context);
    ...
    /// </summary>
    internal protected virtual TExprResult VisitProgramIdDim(Distributed.ProgramIdDim expr, TContext context) => VisitDimension(expr, context);

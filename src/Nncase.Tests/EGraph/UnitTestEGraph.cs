...
public class UnitTestEGraph : TestClassBase
{
    ...
    public void TestLeafExprEqualityComparerFusion()
    {
        var lhs = new Var("lhs");
        var rhs = new Var("rhs");
        var f1 = new Fusion("MeshFunc", BaseFunction.CPUModuleKind, lhs + rhs, new[] { lhs, rhs });
        var f2 = new Fusion("MeshFunc", BaseFunction.CPUModuleKind, lhs + rhs, new[] { lhs, rhs });
        var f3 = new Fusion("MeshFunc", BaseFunction.CPUModuleKind, lhs - rhs, new[] { lhs, rhs });

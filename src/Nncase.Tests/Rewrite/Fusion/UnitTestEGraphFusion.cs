...
public class UnitTestEGraphFusion : TestClassBase
{
    ...
    public async Task TestDataFlowFusionCycleFailedCase()
    {
        ...
        Function main;
        {
            ...
            var fusion_1 = new Fusion("fusion_1", BaseFunction.CPUModuleKind, IR.F.Tensors.NHWCToNCHW(fusion_1_input), new[] { fusion_1_input });
            ...
            var fusion_4 = new Fusion("fusion_4", BaseFunction.CPUModuleKind, IR.F.Math.Add(fusion_4_input[0], fusion_4_input[1]), fusion_4_input);
    ...
    public async Task TestLineSameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_1 = new Fusion("fusion_1", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Abs, fusion_1_input), new[] { fusion_1_input });
            ...
            var fusion_2 = new Fusion("fusion_2", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Cos, fusion_2_input), new[] { fusion_2_input });
            var v_1 = new Call(fusion_2, v_0);

            var fusion_3_input = new Var("fusion_3_input", new TensorType(DataTypes.Float32, new int[] { 1, 32, 32 }));
            var fusion_3 = new Fusion("fusion_3", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Neg, fusion_3_input), new[] { fusion_3_input });
    ...
    public async Task TestYSameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_4 = new Fusion("fusion_4", BaseFunction.CPUModuleKind, IR.F.Math.Binary(BinaryOp.Add, fusion_4_input_0, fusion_4_input_1), new[] { fusion_4_input_0, fusion_4_input_1 });
    ...
    public async Task TestHandInHandSameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_2 = new Fusion("fusion_2", BaseFunction.CPUModuleKind, IR.F.Math.Binary(BinaryOp.Add, IR.F.Math.Unary(UnaryOp.Cos, fusion_2_input_0), IR.F.Math.Unary(UnaryOp.Sin, fusion_2_input_1)), new[] { fusion_2_input_0, fusion_2_input_1 });
    ...
    public async Task TestCircle1SameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_3 = new Fusion("fusion_3", BaseFunction.CPUModuleKind, IR.F.Math.Binary(BinaryOp.Add, fusion_3_input_0, fusion_3_input_1), new[] { fusion_3_input_0, fusion_3_input_1 });
    ...
    public async Task TestCircle3SameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_4 = new Fusion("fusion_4", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Neg, fusion_4_input), new[] { fusion_4_input });
            ...
            var fusion_5 = new Fusion("fusion_5", BaseFunction.CPUModuleKind, IR.F.Math.Binary(BinaryOp.Add, fusion_5_input_0, fusion_5_input_1), new[] { fusion_5_input_0, fusion_5_input_1 });
    ...
    public async Task TestCircle4SameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_3_input = new Var("fusion_3_input", new TensorType(DataTypes.Float32, new int[] { 1, 32, 32 }));
            var fusion_3 = new Fusion("fusion_3", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Sin, fusion_3_input), new[] { fusion_3_input });
            var v_2 = new Call(fusion_3, v_1);
    ...
    public async Task TestTuple2SameModule()
    {
        ...
        Function main;
        {
            ...
            var fusion_3_input = new Var("fusion_3_input", new TensorType(DataTypes.Float32, new int[] { 1, 32, 32 }));
            var fusion_3 = new Fusion("fusion_3", BaseFunction.CPUModuleKind, IR.F.Math.Unary(UnaryOp.Abs, fusion_3_input), new[] { fusion_3_input });
            var v_2 = new Call(fusion_3, v_0);

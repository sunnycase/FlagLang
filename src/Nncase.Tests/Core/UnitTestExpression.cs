...
public class UnitTestExpression
{
    ...
    public void TestConstBufferNotEqual()
    {
        ...
        var ddr_ld_output = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", new TensorType(DataTypes.Float32, new RankedShape(1, 16, 64, 400)), new MemSpan(new PhysicalBuffer(8, 0, 0, BufferStorage.GlobalInput())), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 })), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
    ...
    {
        var ddr_ld_input = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", new TensorType(DataTypes.Float32, new RankedShape(1, 16, 64, 400)), new MemSpan(new PhysicalBuffer(8, 0, 0, BufferStorage.GlobalInput())), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 })), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
        var ddr_ld_output = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", new TensorType(DataTypes.Float32, new RankedShape(1, 16, 64, 400)), new MemSpan(new PhysicalBuffer(8, 0, 0, BufferStorage.GlobalInput())), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 })), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
    ...
    {
        var ddr_ld_input = new TIR.BufferRegion(new TIR.Buffer("ddr_ld_input", new TensorType(DataTypes.Float32, new RankedShape(1, 16, 64, 400)), new MemSpan(new PhysicalBuffer(8, 0, 0, BufferStorage.GlobalInput())), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 })), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));
        var glb_ld_output = new TIR.BufferRegion(new TIR.Buffer("glb_ld_output", new TensorType(DataTypes.BFloat16, new RankedShape(1, 16, 64, 400)), new MemSpan(new PhysicalBuffer(8, 0, 0, BufferStorage.ThreadLocalTemp())), new Dimension[] { 1, 16, 64, 400 }, TensorUtilities.GetDefaultStrides(new Dimension[] { 1, 16, 64, 400 })), new(new TIR.Range[] { 0..1, 0..16, 0..31, 0..400 }));

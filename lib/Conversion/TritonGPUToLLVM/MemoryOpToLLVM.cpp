...
struct GlobalScratchAllocOpConversion
    ...
    matchAndRewrite(triton::gpu::GlobalScratchAllocOp op, OpAdaptor adaptor,
        ...
        Value ptr = LLVM::getGlobalScratchPtr(loc, rewriter, *targetInfo,
...
struct LocalAllocOpConversion
    ...
    matchAndRewrite(triton::gpu::LocalAllocOp op, OpAdaptor adaptor,
        ...
        auto llvmElemTy =
            typeConverter->convertType(memDescTy.getElementType());
        ...
        if (op.getSrc()) {
            ...
            if (failed(lowerLocalStore(loc, ctx, op.getSrc(), memDescTy,
                                       smemObj, inVals, typeConverter, rewriter,
                                       targetInfo))) {
                return failure();
            }
        }

  ...
  public:
    ...
    LogicalResult matchAndRewrite(DotOp dotOp,
        ...
        auto isF32 = [](Value operand) {
            return cast<RankedTensorType>(operand.getType())
                .getElementType()
                .isF32();
        };
        ...
        auto zeroLike = [&](Value c) -> Value {
            return rewriter.create<SplatOp>(
                ...
                rewriter.create<arith::ConstantOp>(
                    dotOp->getLoc(), rewriter.getF32FloatAttr(0)));
        };
        ...
        // +infinity * 0.0 = NaN
        // We would get the wrong result if we sum these partial products.
        // Instead, we must override any accumulated result if the last partial
        // product is non-finite.

...
LLVM::AliasScopeDomainAttr getLoadScopeDomain(MLIRContext *ctx) {
    ...
    return b.getAttr<LLVM::AliasScopeDomainAttr>(
        ...
        b.getStringAttr(
            "Domain to hold alias scopes to specify aliasing information "
            "between "
...
LLVM::AliasScopeAttr getAsyncCopyScope(MLIRContext *ctx) {
    ...
    auto desc = b.getStringAttr("Scope containing all AsyncCopyGlobalToLocal "
                                "and BufferLoadToLocal ops");

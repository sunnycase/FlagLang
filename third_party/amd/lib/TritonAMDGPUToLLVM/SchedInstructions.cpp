...
struct InstructionSchedHintsRewriter
    ...
    matchAndRewrite(triton::amdgpu::InstructionSchedHint instructionSchedHint,
        ...
        // The switch controls whether instructions are allowed to cross the
        // basic block boundaries at the very top and at the very bottom. Note,
        // this is not supposed to be used together with IGLP OPT according to
        // the AMDGPU backend documentation.

...
struct ConvertTritonAMDGPUToLLVM
    ...
    void runOnOperation() override {
        ...
        // Make benefit for AMD specific patterns higher so they apply before
        // common patterns
        ...
        AMD::populateLoadStoreOpToLLVMPatterns(
            typeConverter, targetInfo, patterns, axisInfoAnalysis, AMDBenefit);
        ...
        mlir::triton::AMD::populateTritonAMDGPUToLLVMPatterns(
            typeConverter, patterns, AMDBenefit);
        mlir::triton::AMD::populateUpcastMXFPToLLVMPatterns(
            typeConverter, patterns, targetInfo, AMDBenefit);
        mlir::triton::AMD::populateFp4ToFpToLLVMPatterns(typeConverter,
                                                         patterns, AMDBenefit);

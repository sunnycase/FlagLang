...
MfmaKey composeMfmaKeyFor(Location loc, unsigned version, unsigned mDim,
    ...
    if (withScale) {
        ...
        if (version == 3)
            emitRemark(loc,
                       "for gfx942 please use native supported fp8 variants");
...
#define TRITON_MFMA_v1to4(m, n, aET, bET, symbol, k, kBase)                    \
    ...
    mfmaMap = {
        ...
        TRITON_MFMA_v4_2case(32, 32, bf16T, bf16T, mfma_f32_32x32x16_bf16, 16,
                             8, mfma_f32_32x32x8bf16_1k, 8, 4),
        TRITON_MFMA_v(3, 32, 32, bf16T, bf16T, mfma_f32_32x32x8bf16_1k, 8, 4),
        // mfma_f32_32x32x8_bf16_1K & mfma_f32_32x32x4bf16_1k
        TRITON_MFMA_v2_2case(32, 32, bf16T, bf16T, mfma_f32_32x32x8bf16_1k, 8,
                             4, mfma_f32_32x32x4bf16_1k, 4, 2),
        // mfma_f32_16x16x32_bf16 & mfma_f32_16x16x16_bf16_1K
        TRITON_MFMA_v4_2case(16, 16, bf16T, bf16T, mfma_f32_16x16x32_bf16, 32,
                             8, mfma_f32_16x16x16bf16_1k, 16, 4),
        ...
        TRITON_MFMA_v(4, 32, 32, ocpFp8T, ocpFp8T, mfma_f32_32x32x16_fp8_fp8,
                      16, 8),
        TRITON_MFMA_v(3, 32, 32, amdFp8T, amdFp8T, mfma_f32_32x32x16_fp8_fp8,
                      16, 8),
        // mfma_f32_32x32x16_FP8_BF8
        TRITON_MFMA_v(4, 32, 32, ocpFp8T, ocpBf8T, mfma_f32_32x32x16_fp8_bf8,
                      16, 8),
        TRITON_MFMA_v(3, 32, 32, amdFp8T, amdBf8T, mfma_f32_32x32x16_fp8_bf8,
                      16, 8),
        // mfma_f32_32x32x16_BF8_FP8
        TRITON_MFMA_v(4, 32, 32, ocpBf8T, ocpFp8T, mfma_f32_32x32x16_bf8_fp8,
                      16, 8),
        TRITON_MFMA_v(3, 32, 32, amdBf8T, amdFp8T, mfma_f32_32x32x16_bf8_fp8,
                      16, 8),
        // mfma_f32_32x32x16_BF8_BF8
        TRITON_MFMA_v(4, 32, 32, ocpBf8T, ocpBf8T, mfma_f32_32x32x16_bf8_bf8,
                      16, 8),
        TRITON_MFMA_v(3, 32, 32, amdBf8T, amdBf8T, mfma_f32_32x32x16_bf8_bf8,
                      16, 8),
        // mfma_f32_16x16x32_FP8_FP8
        TRITON_MFMA_v(4, 16, 16, ocpFp8T, ocpFp8T, mfma_f32_16x16x32_fp8_fp8,
                      32, 8),
        TRITON_MFMA_v(3, 16, 16, amdFp8T, amdFp8T, mfma_f32_16x16x32_fp8_fp8,
                      32, 8),
        // mfma_f32_16x16x32_FP8_BF8
        TRITON_MFMA_v(4, 16, 16, ocpFp8T, ocpBf8T, mfma_f32_16x16x32_fp8_bf8,
                      32, 8),
        TRITON_MFMA_v(3, 16, 16, amdFp8T, amdBf8T, mfma_f32_16x16x32_fp8_bf8,
                      32, 8),
        // mfma_f32_16x16x32_BF8_FP8
        TRITON_MFMA_v(4, 16, 16, ocpBf8T, ocpFp8T, mfma_f32_16x16x32_bf8_fp8,
                      32, 8),
        TRITON_MFMA_v(3, 16, 16, amdBf8T, amdFp8T, mfma_f32_16x16x32_bf8_fp8,
                      32, 8),
        // mfma_f32_16x16x32_BF8_BF8
        TRITON_MFMA_v(4, 16, 16, ocpBf8T, ocpBf8T, mfma_f32_16x16x32_bf8_bf8,
                      32, 8),
        TRITON_MFMA_v(3, 16, 16, amdBf8T, amdBf8T, mfma_f32_16x16x32_bf8_bf8,
                      32, 8),
        ...
        TRITON_MFMA_v(4, 16, 16, fp4T, fp4T, mfma_scale_f32_16x16x128_f8f6f4,
                      128, 32),
...
MfmaIntrinsic::selectFor(Location loc, int version, unsigned mDim,
    ...
    for (const auto [symbol, k, kBase] : llvm::drop_end(values)) {
        if (inputKDim >= k)
            return MfmaIntrinsic(symbol, mDim, nDim, k, kBase, aElemType,
                                 bElemType);
    }

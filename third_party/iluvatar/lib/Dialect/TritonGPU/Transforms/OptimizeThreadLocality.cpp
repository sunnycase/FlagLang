    ...
    matchAndRewrite(triton::ReshapeOp viewOp,
        ...
        triton::gpu::BlockedEncodingAttr encoding =
            triton::gpu::BlockedEncodingAttr::get(
                viewOp.getContext(), shape, sizePerThread, order, numWarps,
...
class TritonGPUOptimizeThreadLocalityPass
    ...
    void runOnOperation() override {
        ...
        if (mlir::applyPatternsAndFoldGreedily(mod,
                                               std::move(viewLayoutPatterns))
                .failed()) {
            signalPassFailure();
        }
        ...
        for (auto reduce : reduceOps) {
            ...
            auto slice2d = triton::gpu::SliceEncodingAttr::get(
                mod.getContext(), rank, blocked3d, false);
            // Get forOp
  ...
  private:
    ...
    getThreadLocalityOptimizedEncoding(triton::ReduceOp reduce) const {
        ...
        auto blocked3d = triton::gpu::BlockedEncodingAttr::get(
            ...
            warsPerCTA3d, order3d, ctaLayout3d, false, smeCTA);
        return blocked3d;
    }

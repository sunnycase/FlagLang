...
class DialectInferLayoutInterface
  ...
  public:
    ...
    // elements as before the reshape.  Note that this is not always possible
    // (in which case you'd need to choose a different layout for the input to
    // the reshape).
    virtual LogicalResult inferReshapeOpNoReorderEncoding(

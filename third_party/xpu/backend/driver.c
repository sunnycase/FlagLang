...
static PyObject *loadBinary(PyObject *self, PyObject *args) {
    ...
    XPU_CHECK(__xpu_create_func(&pfunc, type, code_addr, code_byte_size,
                                code_pc, param_dword_size, hash, name, on_xpu,
                                printf_buf_offset));
...
static PyObject *getDeviceProperties(PyObject *self, PyObject *args) {
    ...
    XPU_CHECK(
        xpu_device_get_attr(&num_cluster, XPUATTR_NUM_CLUSTER, device_id));
    multiprocessor_count = num_cluster;

    return Py_BuildValue(
        "{s:i, s:i, s:i, s:i, s:i, s:i, s:i, s:i}", "max_shared_mem",
        max_shared_mem, "max_num_regs", max_num_regs, "max_threads_per_block",
        max_threads_per_block, "multiprocessor_count", multiprocessor_count,
        "warpSize", warp_size, "sm_clock_rate", sm_clock_rate, "mem_clock_rate",

...
struct TritonExpandDimsPattern
    ...
    matchAndRewrite(triton::ExpandDimsOp op, OpAdaptor adaptor,
        ...
        retGroupsPerCluster.insert(retGroupsPerCluster.begin() + op.getAxis(),
                                   1);
        ...
        triton::xpu::ClusterLayoutAttr retEncoding =
            triton::xpu::ClusterLayoutAttr::get(
                getContext(), retSizePerCore, retCoresPerGroup,
                retGroupsPerCluster, retOrder, isReduceOpt);
  ...
  public:
    ...
    void runOnOperation() override {
        ...
        mod->setAttr(
            AttrXPUTargetName,
            StringAttr::get(
                context, "xpu:" + std::to_string(this->xpu_arch.getValue())));

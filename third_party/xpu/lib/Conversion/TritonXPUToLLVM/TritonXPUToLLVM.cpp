...
struct ConvertTritonXPUToLLVM
    ...
    void runOnOperation() override {
        ...
        // Make benefit for XPU specific patterns higher so they apply before
        // common patterns
        ...
        // mlir::triton::xpu::populateDotOpToLLVMPatterns(typeConverter,
        // patterns,
        //                                                benefit);
        ...
        mlir::triton::xpu::populateReduceOpToLLVMPatterns(
            typeConverter, patterns, targetInfo, benefit);
        // mlir::triton::populateScanOpToLLVMPatterns(typeConverter, patterns,
        //                                            targetInfo, benefit);

        // mlir::triton::populateHistogramOpToLLVMPatterns(typeConverter,
        // patterns,
        //                                                 targetInfo, benefit);
        // mlir::triton::populatePrintOpToLLVMPattern(typeConverter, patterns,
        //                                            targetInfo, benefit);
        mlir::triton::populateControlFlowOpToLLVMPattern(typeConverter,
                                                         patterns, benefit);
        ...
        //                                             targetInfo, benefit);
        // mlir::triton::populateMemoryOpToLLVMPattern(typeConverter,
        // targetInfo,
        //                                             patterns, benefit);
  ...
  private:
    ...
    void initSharedMemory(LLVMTypeConverter &typeConverter) {
        ...
        // TODO[dyq]: llvm-18 don't need to set pointer type, this type maybe
        // cause error auto ptrTy =

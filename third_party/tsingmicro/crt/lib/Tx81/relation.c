...
void __BoolGreaterEqualVV(uint64_t *src0, uint64_t *src1, uint64_t *dst,
    ...
    cmd->BoolGreaterEqualVV(&inst, (uint64_t)src0, (uint64_t)src1,
                            (uint64_t)dst, elem_count, (Data_Format)fmt);
...
void __EqualVV(uint64_t *src0, uint64_t *src1, uint64_t *dst,
    ...
    cmd->EqualVV(&inst, (uint64_t)src0, (uint64_t)src1, (uint64_t)dst,
                 elem_count, (Data_Format)fmt);

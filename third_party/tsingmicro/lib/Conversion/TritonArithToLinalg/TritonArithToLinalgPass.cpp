    ...
    void runOnOperation() override {
        ...
        if (ttToFuncFunc) {
            moduleOp.walk([&](triton::FuncOp func) {
                ...
                auto funcFunc =
                    builder.create<func::FuncOp>(func.getLoc(), name, type);
                ...
                for (Block &block : funcFuncBody.getBlocks()) {
                    ...
                    // Only convert to func.return if the terminator is a
                    // tt.return. Otherwise, we will accidentally convert cf.br
                    // ops which are also considered terminators.

...
tests_not_supported = {
    ...
    "test_math_extern",
    "test_cdiv" # Failed due to precision issues in integer division.
}
...
collect_ignore = [
    'test_core.py',
    'test_early_return.py',
    'test_load_2d_tensor_block.py',
    'test_mask.py',
    'test_modulo.py',
    'test_nested_loops.py',
    'test_reduce.py', # Only test gpu compile. No need fix
    'test_scalar_store.py',
    'test_sign_extend.py',
    'test_softmax.py',
    'test_tensor_index_iterargs.py',
    "test_dot_scaled.py",
    "test_flip.py",
    "test_sort.py",
]

...
class PtrAnalysis {
  public:
    ...
    static void visitOperandMakeRange(
    ...
    static void visitOperandExpandDims(
    ...
    static void visitOperandBroadcast(
    ...
    static void visitOperandConstSplat(
    ...
    static void visitOperandReintCast(
        memref::ReinterpretCastOp reintCastOp, PtrState &state,
        const Location loc, ConversionPatternRewriter &rewriter,
        const llvm::SmallDenseMap<Value, PtrState> &knownPtrs);
    ...
    static void
    rewriteAddptrOp(triton::AddPtrOp op, ConversionPatternRewriter &rewriter,
                    llvm::SmallDenseMap<Value, PtrState> &knownPtrs);

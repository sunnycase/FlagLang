...
class CublasLtInstance {
    ...
    typedef cublasStatus_t (*cublasLtMatmul_t)(
        ...
        const cublasLtMatrixLayout_t, const void *,
        const cublasLtMatrixLayout_t, const void *, const void *,
    ...
    void loadCublasDylib() {
        ...
        cublasLtDestroy =
            (cublasLtDestroy_t)dlsym(dylibHandle, "cublasLtDestroy");
        ...
        cublasLtMatmulDescSetAttribute =
            (cublasLtMatmulDescSetAttribute_t)dlsym(
        ...
        cublasLtMatmulPreferenceCreate =
            (cublasLtMatmulPreferenceCreate_t)dlsym(
                dylibHandle, "cublasLtMatmulPreferenceCreate");
        cublasLtMatmulPreferenceDestroy =
            (cublasLtMatmulPreferenceDestroy_t)dlsym(
        ...
        cublasLtMatmulAlgoGetHeuristic =
            (cublasLtMatmulAlgoGetHeuristic_t)dlsym(
    ...
    void gemm_impl(int m, int n, int k, uint64_t A, uint64_t B, uint64_t C,
        ...
        successOrExit(cublasLtMatmul(
            ...
            &beta, (void *)C, Cdesc, (void *)D, Ddesc, &heuristicResult.algo,

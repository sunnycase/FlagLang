...
struct AllocateProtonGlobalScratchBufferPass
    ...
    void runOnOperation() override {
        ...
        mod.walk([&](FunctionOpInterface op) {
            // Ignore any intrinsic functions. On AMD the predicate load/store
            // ops are currently pseduo instrunctions at this point and will get
            // picked up here and trigger the FunctionOpInterface range based
            // assert below
        ...
        bool allAlignmentsEqual = std::equal(

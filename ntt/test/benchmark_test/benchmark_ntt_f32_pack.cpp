...
#if __riscv
    benchmark_ntt_vectorize<ntt::vector<float, P>, 16 * P, 3, 4, 4, 0>("N",
                                                                       300);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 3, 16 * P, 4, 4, 1>("C",
                                                                       300);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 3, 4, 16 * P, 4, 2>("H",
                                                                       300);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 3, 4, 4, 16 * P, 3>("W",
                                                                       300);
    benchmark_ntt_vectorize<ntt::vector<float, P, P>, 4 * P, 3 * P, 4, 4, 0, 1>(
        "NC", 300);
    benchmark_ntt_vectorize<ntt::vector<float, P, P>, 2, 3 * P, 4 * P, 8, 1, 2>(
        "CH", 300);
    benchmark_ntt_vectorize<ntt::vector<float, P, P>, 4, 4, 3 * P, 4 * P, 2, 3>(
        "HW", 300);
#elif __x86_64__
    benchmark_ntt_vectorize<ntt::vector<float, P>, P * 8, 2, 2, 2, 0>("N",
                                                                      2000);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 2, 8 * P, 2, 4, 1>("C",
                                                                      2000);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 2, 2, 8 * P, 8, 2>("H",
                                                                      2000);
    benchmark_ntt_vectorize<ntt::vector<float, P>, 2, 2, 2, 8 * P, 3>("W",
                                                                      2000);
    benchmark_ntt_vectorize<ntt::vector<float, P, P>, 4 * P, 8 * P, 2, 4, 0, 1>(
        "NC", 1);

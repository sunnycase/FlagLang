    ...
    def __init__(self, target: str, bin_path: str, data_type: str = "f32"):
        ...
        if data_type == "f32":
            self.roofline_dict = {
                ...
                'gather': {
                    'vectorize1d_dim0_contiguous': '1.5',
                ...
                'softmax': {
                    'fixed_reduceAxis1_noVectorize': '11130',
                ...
                'layernorm': {
                    'fixed_reduceAxis1_noVectorize': '5330',
                ...
                'rmsnorm': {
                    'fixed_reduceAxis1_noVectorize': '3220',
            ...
            if data_type == "fp16":
                self.roofline_dict = {
                    ...
                    'gather': {
                        'vectorize1d_dim0_contiguous': '0.0',
                    ...
                    'layernorm': {
                        'fixed_reduceAxis1_noVectorize': '0.0',
...
class BenchmarkNTT_riscv64(BenchmarkNTT, Benchmark_riscv64):
    ...
    def __init__(self, target: str, bin_path: str, data_type: str = "f32"):
        ...
        if data_type == "f32":
            self.roofline_dict = {
                'binary': {
                    'add': '7.3', 'sub': '7.3', 'mul': '7.3', 'div': '30.3', 'max': '7.3', 'min': '7.3', 'floor_mod':
                    '40.3', 'mod': '35.3', 'pow': '139'
                },
                #   'cast': {'float-int32': '5',
                #            'int32-float': '5',
                #            'float-uint32': '5',
                ...
                'gather': {
                    'vectorize1d_dim0_contiguous': '4.3',
                ...
                'softmax': {
                    'fixed_reduceAxis1_noVectorize': '61940',
                ...
                'layernorm': {
                    'fixed_reduceAxis1_noVectorize': '17140',
                ...
                'rmsnorm': {
                    'fixed_reduceAxis1_noVectorize': '13050',
            ...
            if data_type == "fp16":
                self.roofline_dict = {
                    'binary': {
                        'add': '7.48', 'sub': '7.51', 'mul': '7.68', 'div': '36.97', 'max': '7.68', 'min': '7.68',
                        'floor_mod': '40.3', 'mod': '36.3901', 'pow': '139'
                    },
                    'unary': {
                        'abs': '6.3',
                        'acos': '84',

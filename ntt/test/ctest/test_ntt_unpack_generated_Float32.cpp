...
TEST(UnpackTest_Float32,
    ...
    // ------------------------------------------------------------------
    auto ntt_input =
        ntt::make_tensor<ntt::vector<float, P, P>>(ntt::fixed_shape_v<C, H, W>);
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<C * P, H * P, W>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<C, H * P, W * P>);
...
TEST(UnpackTest_Float32,
    ...
    // ------------------------------------------------------------------
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor = ntt::make_tensor<ntt::vector<float, P, P>>(
        ntt::fixed_shape_v<C, (H) * 2, W>);
    NttTest::init_tensor(big_tensor, min_input, max_input);

    auto ntt_input =
        ntt::make_tensor_view_from_address<ntt::vector<float, P, P>>(
            big_tensor.elements().data(), ntt::fixed_shape_v<C, H, W>,
            big_tensor.strides());
...
TEST(UnpackTest_Float32,
    ...
    // Create non-contiguous tensor (on dimension 1)
    auto big_tensor =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::make_shape(C, (H) * 2, W));
    NttTest::init_tensor(big_tensor, min_input, max_input);
...
TEST(UnpackTest_Float32,
    ...
    // ------------------------------------------------------------------
    auto ntt_input =
        ntt::make_tensor<ntt::vector<float, P, P>>(ntt::make_shape(C, H, W));
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(C * P, H * P, W));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(C, H * P, W * P));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N * P, C * P, H, W>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N, C * P, H * P, W>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N, C, H * P, W * P>);
...
TEST(UnpackTest_Float32,
    ...
    // 1. build ORT input tensor
    // ------------------------------------------------------------------
    auto continuous_input = ntt::make_tensor<ntt::vector<float, P, P>>(
        ntt::fixed_shape_v<N, C, H, W>);
...
TEST(UnpackTest_Float32,
    ...
    // ------------------------------------------------------------------
    auto ntt_input =
        ntt::make_tensor<ntt::vector<float, P, P>>(ntt::make_shape(N, C, H, W));
    NttTest::init_tensor(ntt_input, min_input, max_input);
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N * P, C * P, H, W));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N, C * P, H * P, W));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N, C, H * P, W * P));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N * P, C * P, H, W, D>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N, C * P, H * P, W, D>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N, C, H * P, W * P, D>);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::fixed_shape_v<N, C, H, W * P, D * P>);
...
TEST(UnpackTest_Float32,
    ...
    // ------------------------------------------------------------------
    auto ntt_input =
        ntt::make_tensor<ntt::vector<float, P>>(ntt::make_shape(N, C, H, W, D));
    NttTest::init_tensor(ntt_input, min_input, max_input);
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N * P, C * P, H, W, D));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N, C * P, H * P, W, D));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N, C, H * P, W * P, D));
...
TEST(UnpackTest_Float32,
    ...
    // Create output tensor
    auto ntt_output1 =
        ntt::make_tensor<float>(ntt::make_shape(N, C, H, W * P, D * P));

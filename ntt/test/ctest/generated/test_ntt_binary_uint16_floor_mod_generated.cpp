...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_fixed_scalar_raw_tensor_no_broadcast) {
    //---init ntt_input_lhs---
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_fixed_1D_vector_raw_tensor_no_broadcast) {
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_fixed_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_fixed_scalar_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_fixed_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_fixed_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_fixed_scalar_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_fixed_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_fixed_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_dynamic_scalar_raw_tensor_no_broadcast) {
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
    //---init ntt_input_rhs---
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_dynamic_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_scalar_raw_tensor_rhs_dynamic_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_dynamic_scalar_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_dynamic_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_1D_vector_raw_tensor_rhs_dynamic_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_dynamic_scalar_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_dynamic_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_fixed_2D_vector_raw_tensor_rhs_dynamic_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<ntt::vector<uint16_t, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_dynamic_scalar_raw_tensor_rhs_fixed_scalar_raw_tensor_no_broadcast) {
    //---init ntt_input_lhs---
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_dynamic_scalar_raw_tensor_rhs_fixed_1D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::make_shape(2, 3, 16, 16));
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);
...
TEST(BinaryTestfloor_mod_Uint16, Uint16_lhs_dynamic_scalar_raw_tensor_rhs_fixed_2D_vector_raw_tensor_no_broadcast) {
    constexpr size_t P = NTT_VLEN / (sizeof(uint16_t) * 8);
    //---init ntt_input_lhs---
    auto ntt_input_lhs = ntt::make_tensor<uint16_t>(ntt::make_shape(2, 3, 16, 16));
    NttTest::init_tensor(ntt_input_lhs, 0, 256, true, true);

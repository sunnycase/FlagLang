...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_scalar_raw_tensor_shape1) {
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
    // ------------------------------------------------------------------
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_scalar_view_dim2_add3_shape1) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 3, (16) +3, 16>);
    NttTest::init_tensor(big_tensor, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_1D_vector_raw_tensor_shape1) {
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_1D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_2D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_2D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_scalar_raw_tensor_shape2) {
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_scalar_view_dim2_add3_shape2) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_1D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_1D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_2D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_fixed_2D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_scalar_raw_tensor_shape1) {
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
    // ------------------------------------------------------------------
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_scalar_view_dim2_add3_shape1) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 3, (16) +3, 16>);
    NttTest::init_tensor(big_tensor, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_1D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_1D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::fixed_shape_v<2, 3, (16) +3, 16>);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_2D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::fixed_shape_v<2, 3, 16, 16>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_2D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::fixed_shape_v<2, 3, (16) +3, 16>);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_scalar_raw_tensor_shape2) {
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 1, 16, 7>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
    // ------------------------------------------------------------------
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_scalar_view_dim2_add3_shape2) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<bfloat16>(ntt::fixed_shape_v<2, 1, (16) +3, 7>);
    NttTest::init_tensor(big_tensor, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_1D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::fixed_shape_v<2, 1, 16, 7>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_1D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::fixed_shape_v<2, 1, (16) +3, 7>);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_2D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::fixed_shape_v<2, 1, 16, 7>);
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_fixed_output_dynamic_2D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::fixed_shape_v<2, 1, (16) +3, 7>);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_scalar_raw_tensor_shape1) {
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_scalar_view_dim2_add3_shape1) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_1D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_1D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_2D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_2D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_scalar_raw_tensor_shape2) {
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_scalar_view_dim2_add3_shape2) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_1D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_1D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_2D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_fixed_2D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_scalar_raw_tensor_shape1) {
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<bfloat16>(ntt::make_shape(2, 3, 16, 16));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
    // ------------------------------------------------------------------
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_scalar_view_dim2_add3_shape1) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<bfloat16>(ntt::make_shape(2, 3, (16) +3, 16));
    NttTest::init_tensor(big_tensor, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_1D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::make_shape(2, 3, 16, 16));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_1D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::make_shape(2, 3, (16) +3, 16));
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_2D_vector_raw_tensor_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::make_shape(2, 3, 16, 16));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_2D_vector_view_dim2_add3_shape1) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::make_shape(2, 3, (16) +3, 16));
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_scalar_raw_tensor_shape2) {
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<bfloat16>(ntt::make_shape(2, 1, 16, 7));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
    // ------------------------------------------------------------------
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_scalar_view_dim2_add3_shape2) {
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<bfloat16>(ntt::make_shape(2, 1, (16) +3, 7));
    NttTest::init_tensor(big_tensor, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_1D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::make_shape(2, 1, 16, 7));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_1D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, P>>(ntt::make_shape(2, 1, (16) +3, 7));
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_2D_vector_raw_tensor_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    auto ntt_input = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::make_shape(2, 1, 16, 7));
    NttTest::init_tensor(ntt_input, -70.0_bf16, 70.0_bf16, true, false);
...
TEST(UnaryTestexp_Bfloat16, Bfloat16_input_dynamic_output_dynamic_2D_vector_view_dim2_add3_shape2) {
    constexpr size_t P = NTT_VLEN / (sizeof(bfloat16) * 8);
    //---init ntt_input---
    // Create non-contiguous tensor (on dimension 2)
    auto big_tensor = ntt::make_tensor<ntt::vector<bfloat16, 4, P>>(ntt::make_shape(2, 1, (16) +3, 7));

...
TEST(
    BinaryTestouter_product_Float8e5m2,
...
TEST(
    ...
    // ------------------------------------------------------------------
    // Create output tensor
    auto ntt_output = ntt::make_tensor<ntt::vector<float_e5m2_t, P, P>>(
        ntt::fixed_shape_v<2, 3, 16, 16>);
    ...
    auto ntt_input_lhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<2, 3, 16, 16, P, 1>);
    ...
    auto ntt_golden_unsqueeze =
        ntt::make_tensor<ntt::vector<float_e5m2_t, P, P>>(
...
TEST(
    ...
    auto ntt_input_lhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<1, P, 1>);
    ntt::unpack(ntt_input_lhs_unsqueezed, ntt_input_lhs_aligned,
                fixed_shape_v<1>);
    auto ntt_input_rhs_unsqueezed =
        (ntt_input_rhs).unsqueeze(fixed_shape_v<4, 5>);
...
TEST(
    ...
    auto ntt_input_lhs_unsqueezed =
        (ntt_input_lhs).unsqueeze(fixed_shape_v<1, 2>);
    auto ntt_input_lhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<16, P, 1>);
    ntt::unpack(ntt_input_lhs_unsqueezed, ntt_input_lhs_aligned,
                fixed_shape_v<1>);
    auto ntt_input_rhs_unsqueezed =
        (ntt_input_rhs).unsqueeze(fixed_shape_v<4, 5>);
...
TEST(
    ...
    auto ntt_input_rhs_unsqueezed =
        (ntt_input_rhs).unsqueeze(fixed_shape_v<1, 2>);
    auto ntt_input_rhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<16, 1, P>);
    ntt::unpack(ntt_input_rhs_unsqueezed, ntt_input_rhs_aligned,
                fixed_shape_v<2>);
    // 1.2 get ntt_lhs/rhs_double
    auto ntt_lhs_double =
...
TEST(
    ...
    auto ntt_input_lhs_unsqueezed =
        (ntt_input_lhs).unsqueeze(fixed_shape_v<4, 5>);
    auto ntt_input_lhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<2, 1, 16, 1, P, 1>);
    ntt::unpack(ntt_input_lhs_unsqueezed, ntt_input_lhs_aligned,
                fixed_shape_v<4>);
    auto ntt_input_rhs_unsqueezed =
        (ntt_input_rhs).unsqueeze(fixed_shape_v<4, 5>);
    auto ntt_input_rhs_aligned =
        ntt::make_tensor<float_e5m2_t>(fixed_shape_v<1, 3, 1, 16, 1, P>);
    ntt::unpack(ntt_input_rhs_unsqueezed, ntt_input_rhs_aligned,
                fixed_shape_v<5>);
    // 1.2 get ntt_lhs/rhs_double
    auto ntt_lhs_double =

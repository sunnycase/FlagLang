...
class CoarseSchedule {
  public:
    ...
    bool insertDepsOfOp(Operation *op, int stage,
                        CoarseSchedule::Cluster cluster, bool includeArg,
                        bool insertIfEarlier = false);
    ...
    // operations before the op and one containing op and all operations after
    // the op. Return the cluster containing op and all operations after the op.
